...
public class Schedule implements Serializable {
	...
	public Optional<Seance> findSeance(Seance otherSeance) {
		Predicate<Seance> isEqual = seance -> seance.getMovie().getTitle().equalsIgnoreCase(
				otherSeance.getMovie().getTitle()) && seance.getStartTime().equals(otherSeance.getStartTime())
